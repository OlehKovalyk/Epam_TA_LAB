package com.epam.lab10.application;
...
import com.epam.lab10.wrapperscanner.WrapperScanner;
...
public class Application {
	...
	public static void main(String[] args) {
		PropertyConfigurator.configure("src\\java\\resource\\log4j.properties");
		while (true) {
			try {
				switch (menu()) {
				case 1:
